---
title: "A practical guide for Genotyping-by-Sequencing (GBS) data SNP and dosage calling  in polyploid species"
...
[Reads2Map](https://github.com/Cristianetaniguti/Reads2Map) is a collection of WDL workflows to build linkage maps from sequencing data. It was first developed to diploids ([preprint](https://www.biorxiv.org/content/10.1101/2022.11.24.517847v2)) and is being expanded to polyploids. 

## SNP calling with GATK and freebayes (EmpiricalSNPCalling.wdl)
...
![EmpiricalSNPCalling](../tools2023/images/EmpiricalSNPCalling.svg)
...
![create_alignment_from_gamilies_files](../tools2023/images/create_alignment_from_families_files.svg)

<br/><br/>

![gatk_genotyping](../tools2023/images/gatk_genotyping.svg)

<br/><br/>

![freebayes_genotyping](../tools2023/images/freebayes_genotyping.svg)
...
* [EmpiricalSNPCalling workflow - Reads2Map](https://github.com/Cristianetaniguti/Reads2Map/releases/tag/EmpiricalSNPCalling_v1.2.0)
...
Prepare input file `EmpiricalSNPCalling_input.json`:
...
```{bash, eval=FALSE}
java -jar -Dconfig.file=cromwell_no_mysql.conf -jar cromwell-85.jar run EmpiricalSNPCalling_v1.2.0.wdl \
                      -i EmpiricalSNPCalling_input.json \
                      -p EmpiricalSNPCalling_v1.2.0.zip
```
...
# Data set (122 rose individuals Chr04)
...
```{bash, eval=FALSE}
  java -jar -Dconfig.file=cromwell_no_mysql.conf -jar cromwell-85.jar run EmpiricalMaps_v1.2.3.wdl \
